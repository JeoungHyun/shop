...
<body>
	<table>
		...
		<a href="javascript:disp_div('minfo','tab1')">회원 정보 보기</a></td>
			<c:if test="${param.id != 'admin' }">
				<td id="tab2" class="tab">
					<a href="javascript:disp_div('oinfo','tab2')">주문 정보 보기</a></td>
					</c:if></tr>	
	</table>
	<%-- oinfo : 주문 정보 출력 --%>
		...
		<tr><td align="center">
			...
			<tr id="saleLine${stat.index }" class="saleLine">
				...
				<table>
					...
					<th width="25%">구매수량</th><th width="25%">상품금액</th></tr>
